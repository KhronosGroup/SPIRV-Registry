...
only be allocated in *Function*, *Private*, *UniformConstant*, *Uniform*,
*Workgroup*, *StorageBuffer*, *PhysicalStorageBuffer*, *PushConstant*,
...
|2|2026-07-27|Ben Ashbaugh|Added UniformConstant to the list of supported storage classes
|========================================
