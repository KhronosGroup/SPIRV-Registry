...
| 0x0 | *None* |
Out of bounds access is undefined behavior regardless of the host environment.
...
Host environment may define out of bounds as undefined behavior even if this operand is used. +
...
|8|2025-11-07|Hans-Kristian Arntzen|Clarify robustness behavior
|========================================
