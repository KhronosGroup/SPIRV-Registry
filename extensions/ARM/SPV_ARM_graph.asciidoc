...
A module must not have two *OpGraphEntryPointARM* instructions with the same Name string. +
 +
...
|3|2026-06-19|Kevin Petit|Forbid multiple *OpGraphEntryPointARM* with the same _Name_ within a module
