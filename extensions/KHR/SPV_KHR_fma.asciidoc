...
In section 3.15 "FP Fast Math Mode", following "Only valid on ...", add
*OpFmaKHR*.
...
|2|2026-06-29|Arseniy Obolenskiy|Clarify that OpFmaKHR results may be decorated with FPFastMathMode.
|========================================
